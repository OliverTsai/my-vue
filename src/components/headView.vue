	...
	<header class="headerBd p-3">
		<div class="headerBox2">
			...
			<router-link to="/basketball" :class="{ active: isActive('/basketball') }" class="router-link">
				<div class="pcRouterBox">
					<div class="pcRouterImg">
						<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-dribbble" viewBox="0 0 16 16">
...
<style lang="scss">
	...
	header{
		height: 40px; /*K*/
		background: #003e5d;  /* fallback for old browsers */
