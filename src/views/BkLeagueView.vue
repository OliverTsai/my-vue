                    ...
                    <div v-else>
                        <div v-for="league in leagues" :key="league.leagueId" class="leagueBox p-2">
                            <div class="bodyListBox w-100">
                                ...
                                <div v-if="this.$i18n.locale === 'en'" class="ColumnW26 bodyListLeft">{{ league.homeTeamEn }}</div>
                                <div v-if="this.$i18n.locale === 'zh_cn'" class="ColumnW26 bodyListLeft">{{ league.homeTeamChs }}</div>
                                <div v-if="this.$i18n.locale === 'zh_hk'" class="ColumnW26 bodyListLeft">{{ league.homeTeamCht }}</div>
                                <div class="ColumnW8 teamImgFlex">
                                    <div class="teamImgBox">
                                        <img :src="getImageTeam(league.homeTeamId)" class="w-100">
                                    </div>
                                </div>
                                <div class="ColumnW8 text-danger">{{ league.homeScore }} - {{ league.awayScore }}</div>
                                <div class="ColumnW8">
                                    <div class="teamImgBox">
                                        <img :src="getImageTeam(league.awayTeamId)" class="w-100">
                                    </div>
                                </div>
                                <div v-if="this.$i18n.locale === 'en'" class="ColumnW26 bodyListRight">{{ league.awayTeamEn }}</div>
                                <div v-if="this.$i18n.locale === 'zh_cn'" class="ColumnW26 bodyListRight">{{ league.awayTeamChs }}</div>
                                <div v-if="this.$i18n.locale === 'zh_hk'" class="ColumnW26 bodyListRight">{{ league.awayTeamCht }}</div>
                                <div v-if="[1, 2, 3, 4, 5].includes(league.matchState)" class="ColumnW8 bodyListLive">
...
import side from '@/components/bkSideView.vue';
...
export default {
    ...
    setup(){
        ...
        const leagueId = ref(String(route.params.bk_league_id));
        ...
        // 監聽 leagueId 變化
        watch(() => route.params.bk_league_id, (newId) => {
